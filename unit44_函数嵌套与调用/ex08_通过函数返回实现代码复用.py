...
# 定义批量新增图书的方法，重复调用新增单一图书的方法即可

def add_books(bs):
    for b in bs:
        add_book(b['title'], b['author'], b['price'])


add_books([
    {'title': '白雪公主', 'author': '安徒生', 'price': 10},
    {'title': '灰姑娘', 'author': '安徒生', 'price': 20},
    {'title': '海的女儿', 'author': '格林', 'price': 30}])
